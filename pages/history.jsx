...
import { GET_USER_AI_iMAGE, CHECK_AUTH } from "../Utils";
...
const History = () => {
  ...
  const CALLING_ALL_POST = async () => {
    try {
      const res = await GET_USER_AI_iMAGE();
      console.log(res);
      ...
      <div className="mb-[56px] sm:mb-0 sm:mt-[56px] ">
        <div className="flex flex-col">
          ...
          <div className="w-full overflow-x-hiden flex flex-col items-center py-4 mt=16">
            ...
            md:text-7xl mb-8 font-logo font-bold mty-0 text-center"
            >
              {" "}
              History
            </a>
                ...
                >
                  ...
                  <div className="m-8">
                    <button
                      ...
                      justify-center text-center h-9 hover:brightness-110 rounded-full bg-opacity-0
                      shadow-sm mt-1 bg-gradient-to-t from-indigo-900 via-indigo-900 to-indigo-800 "
                    >
                      Search
                    </button>
                  </div>
